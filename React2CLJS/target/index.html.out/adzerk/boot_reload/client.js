...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__12275,opts){
var map__12276 = p__12275;
var map__12276__$1 = ((((!((map__12276 == null)))?((((map__12276.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12276.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12276):map__12276);
var files = cljs.core.get.call(null,map__12276__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__7513__auto___12282 = arguments.length;
var i__7514__auto___12283 = (0);
while(true){
if((i__7514__auto___12283 < len__7513__auto___12282)){
args__7520__auto__.push((arguments[i__7514__auto___12283]));

var G__12284 = (i__7514__auto___12283 + (1));
i__7514__auto___12283 = G__12284;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__12280){
var vec__12281 = p__12280;
var opts = cljs.core.nth.call(null,vec__12281,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__12281,opts){
return (function (evt){
...
});})(conn,vec__12281,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__12281,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__12281,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__12281,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq12278){
var G__12279 = cljs.core.first.call(null,seq12278);
var seq12278__$1 = cljs.core.next.call(null,seq12278);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__12279,seq12278__$1);
});
