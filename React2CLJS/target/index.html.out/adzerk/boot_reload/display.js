...
return (function (p__9007){
var vec__9008 = p__9007;
var attr = cljs.core.nth.call(null,vec__9008,(0),null);
var v = cljs.core.nth.call(null,vec__9008,(1),null);
...
var args9009 = [];
var len__7513__auto___9012 = arguments.length;
var i__7514__auto___9013 = (0);
while(true){
if((i__7514__auto___9013 < len__7513__auto___9012)){
args9009.push((arguments[i__7514__auto___9013]));

var G__9014 = (i__7514__auto___9013 + (1));
i__7514__auto___9013 = G__9014;
continue;
} else {
}
break;
...
var len__7513__auto___9017 = arguments.length;
var i__7514__auto___9018 = (0);
while(true){
if((i__7514__auto___9018 < len__7513__auto___9017)){
args__7520__auto__.push((arguments[i__7514__auto___9018]));

var G__9019 = (i__7514__auto___9018 + (1));
i__7514__auto___9018 = G__9019;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9016){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9016));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9020){
var map__9024 = p__9020;
var map__9024__$1 = ((((!((map__9024 == null)))?((((map__9024.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9024.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9024):map__9024);
var data = map__9024__$1;
var message = cljs.core.get.call(null,map__9024__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9024__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9024__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9026 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9026,goog.events.EventType.CLICK,((function (G__9026,map__9024,map__9024__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9026,map__9024,map__9024__$1,data,message,line,file))
);

return G__9026;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9027){
var map__9031 = p__9027;
var map__9031__$1 = ((((!((map__9031 == null)))?((((map__9031.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9031.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9031):map__9031);
var data = map__9031__$1;
var message = cljs.core.get.call(null,map__9031__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9031__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9031__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9033 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__9033,goog.events.EventType.CLICK,((function (G__9033,map__9031,map__9031__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9033,map__9031,map__9031__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9034){
var map__9038 = p__9034;
var map__9038__$1 = ((((!((map__9038 == null)))?((((map__9038.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9038.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9038):map__9038);
var messages = map__9038__$1;
var warnings = cljs.core.get.call(null,map__9038__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9038__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9040 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9040,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9040,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9041){
var map__9044 = p__9041;
...
var messages = map__9044__$1;
var warnings = cljs.core.get.call(null,map__9044__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9044__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9044,map__9044__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9044,map__9044__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9044,map__9044__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9044,map__9044__$1,messages,warnings,exception))
;
