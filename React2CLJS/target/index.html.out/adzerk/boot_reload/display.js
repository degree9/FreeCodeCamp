...
var attr = cljs.core.nth.call(null,vec__12242,(0),null);
...
var args12243 = [];
var len__7513__auto___12246 = arguments.length;
var i__7514__auto___12247 = (0);
while(true){
if((i__7514__auto___12247 < len__7513__auto___12246)){
args12243.push((arguments[i__7514__auto___12247]));

var G__12248 = (i__7514__auto___12247 + (1));
i__7514__auto___12247 = G__12248;
continue;
} else {
}
break;
...
var len__7513__auto___12251 = arguments.length;
var i__7514__auto___12252 = (0);
while(true){
if((i__7514__auto___12252 < len__7513__auto___12251)){
args__7520__auto__.push((arguments[i__7514__auto___12252]));

var G__12253 = (i__7514__auto___12252 + (1));
i__7514__auto___12252 = G__12253;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq12250){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12250));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__12254){
var map__12258 = p__12254;
var map__12258__$1 = ((((!((map__12258 == null)))?((((map__12258.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12258.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12258):map__12258);
var data = map__12258__$1;
var message = cljs.core.get.call(null,map__12258__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__12258__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12258__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__12260 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__12260,goog.events.EventType.CLICK,((function (G__12260,map__12258,map__12258__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__12260,map__12258,map__12258__$1,data,message,line,file))
);

return G__12260;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__12261){
var map__12265 = p__12261;
var map__12265__$1 = ((((!((map__12265 == null)))?((((map__12265.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12265.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12265):map__12265);
var data = map__12265__$1;
var message = cljs.core.get.call(null,map__12265__$1,new cljs.core.Keyword(null,"message","message",-406056002));
...
goog.events.listen(G__12267,goog.events.EventType.CLICK,((function (G__12267,map__12265,map__12265__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__12267,map__12265,map__12265__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__12268){
var map__12272 = p__12268;
...
var messages = map__12272__$1;
var warnings = cljs.core.get.call(null,map__12272__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12272__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__12274 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__12274,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__12274,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__12275){
var map__12278 = p__12275;
...
var messages = map__12278__$1;
var warnings = cljs.core.get.call(null,map__12278__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12278__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__12278,map__12278__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__12278,map__12278__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__12278,map__12278__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__12278,map__12278__$1,messages,warnings,exception))
;
...
}catch (e12281){if((e12281 instanceof Error)){
var __12282 = e12281;
} else {
throw e12281;
