...
app.picture.param_id = javelin.core.formula.call(null,(function (G__12894){
return new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(G__12894);
})).call(null,app.picture.params);
app.picture.image = javelin.core.formula.call(null,(function (G__12895,G__12897,G__12898,G__12896){
if(cljs.core.truth_(G__12895)){
return G__12896.call(null,G__12897,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [G__12898.call(null,G__12895)], null));
} else {
return null;
}
})).call(null,app.picture.param_id,app.picture.images,cljs.core.keyword,cljs.core.get_in);
app.picture.bg = javelin.core.formula.call(null,(function (G__12899,G__12901,G__12902,G__12900){
if(cljs.core.truth_(G__12899)){
return G__12900.call(null,G__12901,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [G__12902.call(null,G__12899)], null));
} else {
return null;
}
...
,null));
var alt__10729__auto__ = (new cljs.core.Delay(((function (con__10728__auto__,vec__12908,attr,kids){
return (function (){
return hoplon.core.img.call(null,new cljs.core.Keyword(null,"src","src",-1651076051),app.picture.image,new cljs.core.Keyword(null,"click","click",1912301393),((function (con__10728__auto__,vec__12908,attr,kids){
return (function (){
return cljs.core.swap_BANG_.call(null,app.picture.enlarge,cljs.core.not);
});})(con__10728__auto__,vec__12908,attr,kids))
...
,null));
var tpl__10730__auto__ = ((function (con__10728__auto__,alt__10729__auto__,vec__12908,attr,kids){
...
});})(con__10728__auto__,alt__10729__auto__,vec__12908,attr,kids))
;
...
while (G__12913__i < G__12913__a.length) {G__12913__a[G__12913__i] = arguments[G__12913__i + 0]; ++G__12913__i;}
  args__10690__auto__ = new cljs.core.IndexedSeq(G__12913__a,0);
} 
return app$picture$index__delegate.call(this,args__10690__auto__);};
app$picture$index.cljs$lang$maxFixedArity = 0;
app$picture$index.cljs$lang$applyTo = (function (arglist__12914){
var args__10690__auto__ = cljs.core.seq(arglist__12914);
