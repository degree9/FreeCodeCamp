...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__7966,opts){
...
var files = cljs.core.get.call(null,map__7967__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__7513__auto___7973 = arguments.length;
var i__7514__auto___7974 = (0);
while(true){
if((i__7514__auto___7974 < len__7513__auto___7973)){
args__7520__auto__.push((arguments[i__7514__auto___7974]));

var G__7975 = (i__7514__auto___7974 + (1));
i__7514__auto___7974 = G__7975;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__7971){
var vec__7972 = p__7971;
var opts = cljs.core.nth.call(null,vec__7972,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__7972,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__7972,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__7972,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__7972,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq7969){
var G__7970 = cljs.core.first.call(null,seq7969);
var seq7969__$1 = cljs.core.next.call(null,seq7969);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__7970,seq7969__$1);
});
