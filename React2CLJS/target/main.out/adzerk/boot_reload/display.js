...
return (function (p__7807){
var vec__7808 = p__7807;
var attr = cljs.core.nth.call(null,vec__7808,(0),null);
var v = cljs.core.nth.call(null,vec__7808,(1),null);
...
var args7809 = [];
var len__7513__auto___7812 = arguments.length;
var i__7514__auto___7813 = (0);
while(true){
if((i__7514__auto___7813 < len__7513__auto___7812)){
args7809.push((arguments[i__7514__auto___7813]));

var G__7814 = (i__7514__auto___7813 + (1));
i__7514__auto___7813 = G__7814;
continue;
} else {
}
break;
...
var len__7513__auto___7817 = arguments.length;
var i__7514__auto___7818 = (0);
while(true){
if((i__7514__auto___7818 < len__7513__auto___7817)){
args__7520__auto__.push((arguments[i__7514__auto___7818]));

var G__7819 = (i__7514__auto___7818 + (1));
i__7514__auto___7818 = G__7819;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7816){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7816));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7820){
var map__7824 = p__7820;
var map__7824__$1 = ((((!((map__7824 == null)))?((((map__7824.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7824.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7824):map__7824);
var data = map__7824__$1;
var message = cljs.core.get.call(null,map__7824__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7824__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7824__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7826 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7826,goog.events.EventType.CLICK,((function (G__7826,map__7824,map__7824__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7826,map__7824,map__7824__$1,data,message,line,file))
);

return G__7826;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7827){
var map__7831 = p__7827;
var map__7831__$1 = ((((!((map__7831 == null)))?((((map__7831.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7831.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7831):map__7831);
var data = map__7831__$1;
var message = cljs.core.get.call(null,map__7831__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7831__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7831__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7833 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__7833,goog.events.EventType.CLICK,((function (G__7833,map__7831,map__7831__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7833,map__7831,map__7831__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7834){
var map__7838 = p__7834;
var map__7838__$1 = ((((!((map__7838 == null)))?((((map__7838.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7838.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7838):map__7838);
var messages = map__7838__$1;
var warnings = cljs.core.get.call(null,map__7838__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7838__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7840 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7840,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7840,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7841){
var map__7844 = p__7841;
...
var messages = map__7844__$1;
var warnings = cljs.core.get.call(null,map__7844__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7844__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7844,map__7844__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7844,map__7844__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7844,map__7844__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7844,map__7844__$1,messages,warnings,exception))
;
...
}catch (e7847){if((e7847 instanceof Error)){
var __7848 = e7847;
} else {
throw e7847;
